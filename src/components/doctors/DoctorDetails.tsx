...
const DoctorDetails = ({ visible, selectedDoctor, handleClose, handleOpenForm }: DoctorDetailsProps) => {
    const locale = useLocale();
    const t = useTranslations("Doctors");
    const tc = useTranslations("Common");

    const { data: doctorSchedule = [], isFetching } = useQuery({
    ...
    return (
        <AnimatePresence>
            ...
            >
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-1 mt-2">
                                ...
                                <span className="text-xs font-bold text-muted-foreground ms-2">
                                    {selectedDoctor.rating} ({selectedDoctor.review_count} {t("reviews")})
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-8 bg-accent/5 border-t border-border/40 flex gap-4 mt-auto shrink-0">
