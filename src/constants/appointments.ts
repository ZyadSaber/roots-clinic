...
export const typeColors: Record<AppointmentStatus, { bg: string; border: string; text: string }> = {
...
export const ACTIONABLE_STATUSES: AppointmentStatus[] = ["confirmed", "arrived", "in_chair"]
